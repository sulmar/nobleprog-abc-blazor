...
builder.Services.AddScoped<IPasswordHasher<UserIdentity>, PasswordHasher<UserIdentity>>(); // Default: PBKDF2. Consider BCrypt or Argon2 in production.
...
builder.Services.AddScoped<IdentityContext>(sp =>
{
    ...
    var user3 = new UserIdentity
    {
        ...
        Roles = new List<string> { "dev", "support" }, // ← many roles
